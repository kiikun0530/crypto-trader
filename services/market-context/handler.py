...
def handler(event, context):
    ...
    try:
        ...
        print(f"Funding rates: {json.dumps(funding_data['rates'], indent=2)}")
...
def fetch_btc_dominance() -> dict:
    ...
    try:
        ...
        return {'btc_dominance': 50.0, 'eth_dominance': 10.0, 'total_market_cap': 0}
...
def save_market_context(timestamp: int, score: float, components: dict,
    ...
    print(f"Saved market context: score={score:+.4f}, fng={fng_data.get('value', '?')}, "
