...
| 指標 | 重み | 意味 |
|---|---|---|
| RSI (14) | 15-35% | 買われすぎ(>70)/売られすぎ(<30) |
| MACD (12,26,9) | 15-35% | EMA(9)シグナルラインによるクロスオーバー |
| SMA20 vs SMA200 | 15-35% | ゴールデン/デッドクロス |
| Bollinger Bands (20,2) | 15-35% | 線形グラデーション + バンド外ボーナス |
| ADX (14) | - | レジーム検知に使用 (>25:トレンド, <20:レンジ) |
| ATR (14) | - | ボラティリティ指標 (情報出力のみ) |
...
Chronos-T5-Tiny は価格の「方向」を予測する点で優秀。±1%のスケーリングでChronosの40%ウェイトが実質的に機能:
